...
bool solve(string a,string b)
{
    ...
    for(int i=0;i<n-1;i++)
    {
        ...
        if((solve(a.substring(i,n-1),b.substring(0,i)==true)&&solve(a.substring(0,i),b.substring(n-i,i)==true)||(solve(a.substring(0,i),b.substring(0,i)==true) && solve(a.substring(i,n-1),b.substring(i,n-1)==true)) )
        {
            flag=true;
            break;
        }
